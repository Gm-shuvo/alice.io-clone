    ...
    <section className="section-intell">
      <div className="padding-global padding-section-medium">
        <div className="container-large">
          <div className="intell_component stroke-shadow-dark relative">
            ...
            <div className="flex flex-col items-center justify-center gap-6">
              ...
              <div className="text-center max-w-7xl mx-auto">
                <p>
                  ...
                  samples and cross-cultural expert analysis. Rabbit Hole adapts
                  in real time, foreseeing emerging threats, surfacing unseen
                  risks, and feeding guardrails, enabling Alice to test, harden,
                  and protect systems of every kind: from UGC to GenAI and soon
                  enough, humanoid robots.
                  <br />
                  <br />
                  It’s what enables us to protect half the world’s online users
                  from harm, and why leading technology companies and frontier
                  model labs rely on Alice at scale.
                </p>
                ...
                <p>
                  ...
                  to humanoid robots. It’s why leading technology companies and
